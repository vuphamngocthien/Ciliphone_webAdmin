    ...
    <View style={{ flex: 1, alignItems: "center", justifyContent: "center", }}>
      <View style={styles.modal}>
        <View style={{ flexDirection: 'row', margin: 20 }}>
          ...
          <View style={{ flexDirection: 'column' }}>
            <View style={{ marginLeft: 20 }}>
              <TextInput style={{ fontSize: 24, color: "white" }} placeholder="Iphone 14 Pro Max"></TextInput>
            </View>
            <View style={{ marginLeft: 20 }}>
              <TextInput style={{ fontSize: 24, color: "brown" }} placeholder="$1099"></TextInput>
            </View>
          </View>
        </View>
        ...
        <View style={{flexDirection: 'row', justifyContent: 'center', alignItems: 'center'}}>
          <TouchableOpacity
            style={{ justifyContent: "center", alignItems: "center", paddingTop: 80, paddingRight: 70}}
